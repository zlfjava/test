...
public class BaiduOcr {
	...
	public static String getAuth() {
		// 官网获取的 API Key
		String clientId = "LPS2HRFpE4gEp4ZCQQGtGeo3";
		// 官网获取的 Secret Key
		String clientSecret = "IcDaWEMftz4G2NoFMvbcHkreVDba5iVW";
	 ...
	 * @return
	 */
	public static Map<String, String> getHashMapByJson(String jsonResult) {
	 ...
	 * @return
	 */
	public static Map<String, String> getbackByJson(String jsonResult) {
		Map<String, String> map = new HashMap<String, String>();
		try {
			JSONObject jsonObject = new JSONObject(jsonResult);
			JSONObject words_result = jsonObject.getJSONObject("words_result");
